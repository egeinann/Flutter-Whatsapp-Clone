...
class _UserChatScreenState extends State<UserChatScreen> {
        ...
        children: [
          ...
          Scaffold(
            ...
            appBar: AppBar(
              ...
              title: appBarTitle(context, personImage, personName),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: SingleChildScrollView(
                      reverse: true,
                      child: bodyMessages(
                          context, personMessageState, personMessage),
                    ),
                  ),
                  // *** BOTTOM TEXTFILED ***
                  SizedBox(
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: Padding(
                            ...
                            child: textFieldMethod(context),
                          ),
                        ),
                        // *** CHANGING ICONS MIC/SEND ***
                        Expanded(
                          flex: 2,
                          child: microphoneButtonMethod(context),
                        )
                      ],
                    ),
                  ),
  ...
  // *** BODY DE KI MESAJLAR ***
  Column bodyMessages(
      BuildContext context, bool personMessageState, String personMessage) {
    return Column(
      children: [
        // *** IMAGE MESSAGE ***
        BubbleNormalImage(
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: BubbleSpecialOne(
                delivered: Message.myMessage == true ? true : false,
                text: Message.text,
                textStyle: TextStyle(
                    color: Message.isSelected
                        ? const Color.fromARGB(195, 125, 179, 143)
                        : null,
                    fontSize: MediaQuery.of(context).size.width * 0.038,
                    fontWeight: FontWeight.w400),
                isSender: Message.myMessage == true ? true : false,
        ...
        InkWell(
          ...
          child: Container(
            color:
                selectedMessage ? const Color.fromARGB(149, 38, 115, 64) : null,
            width: MediaQuery.of(context).size.width,
            child: BubbleSpecialOne(
              delivered: personMessageState == true ? true : false,
              text: personMessage,
              textStyle: TextStyle(
                  ...
                  fontSize: MediaQuery.of(context).size.width * 0.038,
                  fontWeight: FontWeight.w400),
              isSender: personMessageState == true ? true : false,
  ...
  // *** APP BAR TITLE BAŞLIK ***
  Row appBarTitle(BuildContext context, String personImage, String personName) {
    return Row(
      ...
      children: [
        ...
        Text(
          selectedMessageCount > 0 ? "$selectedMessageCount" : personName,
    ...
    return Row(
      children: [
        ...
        IconButton(
          onPressed: () {},
          icon: Icon(
            selectedMessageCount > 0 ? Ionicons.return_up_forward : Icons.call,
            size: MediaQuery.of(context).size.width * 0.07,
          ),
        ),
        IconButton(
  ...
  // *** DEĞİŞEN İKONLAR MİKROFON/GÖNDER ***
  ElevatedButton microphoneButtonMethod(BuildContext context) {
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
          shape: const CircleBorder(),
          padding: EdgeInsets.all(MediaQuery.of(context).size.width * 0.024),
          backgroundColor: const Color.fromARGB(255, 54, 173, 119)),
      onPressed: () {
      ...
      child: Icon(
        textFieldState == true ? Icons.send : Icons.mic_outlined,
  ...
  // *** BOTTOM ALT TEXTFILED ***
  Container textFieldMethod(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            onPressed: () {},
            icon: Icon(
              textFieldState == false ? Ionicons.attach_sharp : null,
              size: MediaQuery.of(context).size.width * 0.07,
              color: Colors.grey,
            ),
          ),
  ...
  // *** ADD NEW MESSAGE FUNCTION YENI MESAJ EKLEME ***
  void _addMessage() {
    setState(() {
