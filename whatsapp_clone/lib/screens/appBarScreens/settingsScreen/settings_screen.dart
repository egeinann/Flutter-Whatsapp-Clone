...
class _SettingsScreenState extends State<SettingsScreen> {
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              // *** SETTINGS ***
              for (var Setting in settings) settingsListTile(Setting, context),
              // *** BOTTOM TEXTS ***
              bottomTextsIcons(context),
  ...
  // *** BOTTOM TEXTS ICONS ***
  Column bottomTextsIcons(BuildContext context) {
    return Column(
      children: [
        Text(
          "from",
  ...
  // *** SETTINGS ITEMS LIST TILE ***
  InkWell settingsListTile(Setting Setting, BuildContext context) {
    return InkWell(
      onTap: () {
  ...
  // *** TOP MY LIST TILE CARD ***
  ListTile topMyListTile(BuildContext context) {
    return ListTile(
